(** * Girard/Hurkens paradoxes in Coq, and the loophole that used to reach them
    ...
    theory, not a bug.  Contrast with ../../KernelDefects/Coq/, which holds
    genuine implementation defects, and ../../EscapeHatches/Coq/TypingFlags.v,
    which reaches section 1's hypothesis by simply switching the check off.

    Toolchain: The Rocq Prover 9.2 (OCaml 4.14.2).  Verified by ../verify.ps1.
