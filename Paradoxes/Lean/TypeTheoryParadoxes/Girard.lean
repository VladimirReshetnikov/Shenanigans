...
namespace TypeTheoryParadoxes.Girard
...
/-- info: 'TypeTheoryParadoxes.Girard.girard' does not depend on any axioms -/
...
/-- info: 'TypeTheoryParadoxes.Girard.no_internal_universe' does not depend on any axioms -/
#guard_msgs in #print axioms no_internal_universe

end TypeTheoryParadoxes.Girard
